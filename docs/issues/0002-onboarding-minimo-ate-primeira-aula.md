# Onboarding minimo ate primeira Aula

## What to build

Criar o fluxo inicial para quando o app ainda nao tem dados. O onboarding deve guiar o **Professor** pela criacao da primeira **Turma**, primeira **Disciplina**, primeiros **Alunos** e primeiro item da **Grade Semanal**. Ao concluir, o app deve abrir na tela Hoje com uma **Aula atual** ou **Proxima aula** quando aplicavel.
