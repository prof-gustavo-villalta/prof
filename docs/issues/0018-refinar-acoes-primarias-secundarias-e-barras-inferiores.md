...
- [ ] Telas com proxima acao obvia usam `BottomActionBar` ou `BottomSplitActionBar` de forma consistente.
- [ ] Acoes primarias usam cor, texto e posicao consistentes com o **Design System**.
- [ ] Acoes secundarias, destrutivas ou de cancelamento ficam diferenciadas sem parecerem a acao principal.
