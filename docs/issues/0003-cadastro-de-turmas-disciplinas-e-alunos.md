# Cadastro de Turmas, Disciplinas e Alunos

## What to build

Implementar o cadastro principal de **Turmas**, **Disciplinas** e **Alunos** fora do onboarding. **Disciplina** deve ser reutilizavel entre varias **Turmas**. **Turma** deve ter **Periodo letivo** em texto livre e datas inicial/final opcionais. O cadastro de **Alunos** deve permitir inclusao individual e criacao em massa por lista colada, um nome por linha.
...
- docs/issues/0001-base-local-first-e-navegacao-mobile-first.md
